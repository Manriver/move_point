    ...
    cartodb.createLayer(map,viz)
        ...
        function getSearch(){
            ...
            if (optioncalle != "*" && optioncalle != null ){
                    ...
                    bounry({user: "finanzasdf-admin"}, '"finanzasdf-admin".basecalle_copy'," delegacionesid="+optiondelegacion+" AND coloniaid="+optioncolonia+" AND  nombrecalle = '"+optioncalle+"'", "", map)
				...
				geojsonLayer = L.geoJson(data, {
					...
					onEachFeature: function (feature, layer) {
					    if (feature.geometry.type === 'Point') {
                            ...
                            // L.marker(latlng, { icon: L.BeautifyIcon.icon(), draggable: true }).addTo(map).bindPopup("<b>ID carto: </b>"+feature.properties.cartodb_id+"<br>"+
