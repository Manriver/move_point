...
//$result = $client->call('echoback', $utf8string); Ã±
//$pregunta = array("Cuenta" => '029077030004', "Password" => "contraseña", "Usuario" => "ovica");
$result = $client->call('solicitar_adeudo_vigente', array("pregunta" => array("Cuenta" => '029077030004', "Password" => "contraseña", "Usuario" => "ovica")));
if ($client->fault) {
