...
$client = new soapclient('http://10.1.253.86:8080/PRO/Pro_WebService/WcfSecretaria.Service1.svc?wsdl', true,
...
$pregunta = array('Cuenta' => '029077030004', 'Password' => 'contraseña', 'Usuario' => 'ovica');
$result = $client->call('solicitar_adeudo_vigente', array('pregunta' => $pregunta));
